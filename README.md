...
```javascript
// 1. 构建现金流数组
cashFlows = [-投资金额, 回款1, 回款2, ...]

// 2. 使用牛顿迭代法求周期IRR
NPV(rate) = Σ [CF_t / (1 + rate)^t] = 0
...
### Q1: 为什么投资方的年化IRR比目标回报率高？
**A**: 这是短期快速回款的数学特性。12天就回本+收益，使用复利年化后自然较高。我们同时提供"简单年化收益率"作为对比参考。
